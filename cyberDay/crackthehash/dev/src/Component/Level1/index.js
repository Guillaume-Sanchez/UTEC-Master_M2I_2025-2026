...
function Level1({passwordList}) {
    return (
        <section className='border-b-2 pb-4 m-4 border-[#61dafb]'>
            ...
            <p className='py-2 m-4 border-b-2 border-[#61dafb]'>Pouvez-vous accomplir les tâches du level 1 en déchiffrant ces hachages ?<br/>Vous pouvez vous aider de <a href="https://gchq.github.io/CyberChef/">CyberChef</a></p>
